...
<head>
    ...
    <link rel="stylesheet" href="{{asset('frontend/css/checkout.vendor.min.css?v=4fcd86c')}}">
    <link rel="stylesheet" href="{{asset('frontend/css/checkout.min.css?v=17ca415')}}">
    <style>
    </style>
...
<body>
    ...
    <aside>
        ...
        Đơn hàng ({{count($cartcontent)}} sản phẩm)
        </span>
                    ...
                    <div class="order-summary__sections">
                        ...
                        <table class="product-table">
                            ...
                            <tbody>
                                @foreach ($cartcontent as $item)
                                @php
                                    $discount = ($item['price'] - ($item['price'] * $item['discount'] / 100)) * $item['quantity'];
                                @endphp
                                <tr class="product">
