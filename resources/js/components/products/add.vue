    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="form-group col-6">
                ...
                <vs-input type="number" size="default" icon="all_inclusive" class="w-100" v-model="objData.price" />
            </div>
            <div class="form-group col-6">
                <label>Phần trăm giảm giá</label>
                <vs-input type="number" size="default" icon="all_inclusive" class="w-100" v-model="objData.discount" />
            </div>
            </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <vs-input type="text" size="default" placeholder="Số lượng" class="w-100" v-model="objData.qty" />
            </div>
            <div class="form-group">
                <label>Số lượng đã bán</label>
                <vs-input type="text" size="default" placeholder="Số lượng" class="w-100" v-model="objData.qty_sale" />
            </div>
            <div class="form-group">
                <label>Năm phát hành</label>
                <vs-select class="selectExample" v-model="objData.year" placeholder="Năm phát hành" >
                <vs-select-item v-for="(year, key) in allYears" :value="year" :key="key" :text="year" />
                </vs-select>
            </div>
            <div class="form-group">
...
data() {
    ...
    endYear: new Date().getFullYear(), // Năm kết thúc (hiện tại)
    allYears: [],
    objData: {
        lang: "",
        variant:[],
...
mounted() {
    ...
    this.objData.year= this.endYear; // Chọn năm hiện tại mặc định
},
};
</script>
<style scoped>
