...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    Route::get('get-product-recommend','ProductController@getProductRecommend')->name('getProductRecommend');
    ...
    Route::get('services.html','PageController@serviceList')->name('serviceList');
    Route::get('gallery.html','PageController@listPrize')->name('listPrize');
    ...
    Route::get('contact.html','PageController@contact')->name('contactUs');
    ...
    Route::group(['prefix'=>'blog'], function(){
        Route::get('/thu-thuat.html','BlogController@list')->name('allListBlog');
