...
@endsection
@section('css')
<link data-optimized="1" rel='stylesheet' id='elessi-style-woo-pages-css' href='https://bggamingzone.com/wp-content/litespeed/css/4e9b612d7d366d119a161c0e1be6e7d0.css?ver=6e7d0' type='text/css' media='all' />
@endsection
@section('content')
<div id="nasa-breadcrumb-site" class="bread nasa-breadcrumb style-multi nasa-breadcrumb-has-bg">
    ...
    <div class="large-12 columns nasa-display-table breadcrumb-wrap text-center">
        <nav class="breadcrumb-row" style="height:130px;">
            <span class="nasa-first-breadcrumb">Giỏ hàng</span><span class="breadcrumb"><a href="{{route('home')}}" title="Trang chủ">Trang chủ</a></span>
        </nav>
    </div>
    </div>
</div>
<main id="main-content" class="site-main light nasa-after-clear woocommerce-cart">
    <div class="container-wrap page-shopping-cart">
    <div class="row nasa-cart-content">
        <div class="columns large-12">
            <div  class="section-element">
                <div class="row">
                <div class="large-12 margin-bottom-30 nasa-col columns">
                    <div  class="wpb_text_column wpb_content_element">
                        <div class="woocommerce list-cart">
